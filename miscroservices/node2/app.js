...
app.post("/upload/single", uploadStorage.single("file"), (req, res) => {
  ...
  console.log({hex:hex,fileName:req.file.originalname,filePath:req.file.path});
  return res.status(200).send({hex:hex,fileName:req.file.originalname,filePath:req.file.path});
});
